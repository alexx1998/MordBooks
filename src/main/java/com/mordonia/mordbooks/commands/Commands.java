    ...
    public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
        if(command.getName().equalsIgnoreCase("mb")){
            ...
            if(args[0].equalsIgnoreCase("sign")){
                ...
                ItemStack book = player.getInventory().getItemInMainHand();
                BookMeta bookMeta = (BookMeta) book.getItemMeta();
                String firstname = mcore.playerChatDataManager.get(player).getFirstname();
                String lastname = mcore.playerChatDataManager.get(player).getLastname();
                bookMeta.setAuthor(ChatColor.translateAlternateColorCodes('&',firstname + " " + lastname ));
